...
# --- ターゲット設定（上り線：那覇方面に絞ります） ---
TARGET_BUSES = [
    {
        'name': '120番',
        'keitou': 'c2d5a846-d5ab-41a8-9da6-9ca28e8fa812',
        'course': '703e7e39-1663-4965-b1a7-1903e1e90956' # 120番上り
    },
    {
        'name': '28番',
        'keitou': 'c3b057fe-ccf6-41bf-887a-e4150c77c8c8', 
        'course': '60689b70-7603-4c57-873b-554477c77f0a'  # 28番上り（那覇方面）
    }
]
...
def index():
    ...
    <html>
    <head>
        <title>武田家 バス監視システム vFinal</title>
        <meta charset="utf-8" />
        ...
        <style>
            ...
            #status { height: 15vh; background: #111; color: #fff; padding: 10px; font-family: sans-serif; box-sizing: border-box; }
    ...
    <body>
        <div id="map"></div>
        <div id="status">
            📡 120番・28番(那覇行き) 監視中...<br>
            <span id="info" style="color:#00ff00;">バスを探しています...</span>
        </div>
